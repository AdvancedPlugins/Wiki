...
-   [Home](README.md)
-   [Get AdvancedChallenges](https://advancedplugins.net/item/AdvancedChallenges.212)

## Configuration

-   [Categories](configuration/categories.md)
-   [Challenges](configuration/challenges.md)
-   [Rewards](configuration/rewards.md)
-   [Streaks](configuration/streaks.md)
...
-   [Implementation](api/api-implementing.md)
-   [Custom Challenges](api/api-custom-challenges.md)
